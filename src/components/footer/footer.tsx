...
export const Footer = () => {
  ...
  const year=new Date().getFullYear()
    return(
        <Container fluid as="footer" className="footer" display="flex" flexDirection="column" justifyContent="center" alignItems="center" padding={{ lg: "1rem 1rem", lgDown: "2rem" }} gap={{ lg: "2rem", lgDown: "4" }}>
            <HStack className="footer-icons" justify="center" flexDirection="row"  gap={{ lg: "16px", lgDown: "4" }}>
            <Link 
